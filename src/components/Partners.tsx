...
const Partners = () => {
  ...
  return (
    <section ref={sectionRef} className="py-16 lg:py-24 relative overflow-hidden bg-secondary/30">
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className={`relative transition-all duration-1000 delay-300 ${isVisible ? "opacity-100" : "opacity-0"}`}>
          ...
          <div className="overflow-hidden">
            <div className="flex animate-scroll gap-6 lg:gap-8" style={{ width: 'max-content' }}>
